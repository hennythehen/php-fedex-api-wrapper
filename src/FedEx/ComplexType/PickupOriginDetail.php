    ...
    extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\SimpleType\PickupBuildingLocationType|string $packageLocation
     * @return PickupOriginDetail
     */
     ...
     *
     * @return \FedEx\SimpleType\PickupBuildingLocationType|string
     */
     ...
     * Set BuildingPart
     *
     * @param \FedEx\SimpleType\BuildingPartCode|string $buildingPart
     * @return PickupOriginDetail
     */
     ...
     *
     * @return \FedEx\SimpleType\BuildingPartCode|string
     */
     ...
     * FedEx USE ONLY (with IVR client)
     *
     * @param \FedEx\SimpleType\PickupRequestType|string $pickupDateType
     * @return PickupOriginDetail
     */
