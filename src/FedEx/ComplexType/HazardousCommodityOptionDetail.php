    ...
    extends AbstractComplexType
{
     ...
     *
     * @param \FedEx\SimpleType\HazardousCommodityLabelTextOptionType|string $labelTextOption
     ...
     *
     * @return \FedEx\SimpleType\HazardousCommodityLabelTextOptionType|string
     */
