...
'DocumentIdProducer' => 'UploadDocumentIdProducer',
    ...
    /**
     * @var \FedEx\RateService\SimpleType\UploadDocumentProducerType|string
     */
    public $DocumentProducer;

        
    /**
     * @var \FedEx\RateService\SimpleType\UploadDocumentType|string
     */
    public $DocumentType;
    ...
    /**
     * @var \FedEx\RateService\SimpleType\UploadDocumentIdProducer|string
     */
