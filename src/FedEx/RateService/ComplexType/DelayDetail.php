...
'Description' => 'string',
    ...
    /**
     * @var \FedEx\RateService\SimpleType\DayOfWeekType|string
     */
    public $DayOfWeek;

        
    /**
     * @var \FedEx\RateService\SimpleType\DelayLevelType|string
     */
    public $Level;

        
    /**
     * @var \FedEx\RateService\SimpleType\DelayPointType|string
     */
    public $Point;

        
    /**
     * @var \FedEx\RateService\SimpleType\CommitmentDelayType|string
     */
    public $Type;
