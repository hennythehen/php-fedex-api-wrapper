...
'DocumentIdProducer' => 'UploadDocumentIdProducer',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\UploadDocumentProducerType|string
     */
    public $DocumentProducer;

        
    /**
     * @var \FedEx\ShipService\SimpleType\UploadDocumentType|string
     */
    public $DocumentType;
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\UploadDocumentIdProducer|string
     */
