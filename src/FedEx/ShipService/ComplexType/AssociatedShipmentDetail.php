...
'Label' => 'ShippingDocument',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\AssociatedShipmentType|string
     */
    public $Type;
    ...
    {
        $this->__set('ShipmentOperationalDetail', $shipmentOperationalDetail);
    ...
    {
        $this->__set('PackageOperationalDetail', $packageOperationalDetail);
