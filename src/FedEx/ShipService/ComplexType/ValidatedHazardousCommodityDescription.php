...
'LabelText' => 'string',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\HazardousCommodityPackingGroupType|string
     */
    public $PackingGroup;
    ...
    /**
     * @var HazardousCommodityAttributeType[]
     */
    ...
    {
        $this->__set('ProperShippingNameAndDescription', $properShippingNameAndDescription);
    ...
    {
        $this->__set('TunnelRestrictionCode', $tunnelRestrictionCode);
    ...
    {
        $this->__set('SpecialProvisions', $specialProvisions);
