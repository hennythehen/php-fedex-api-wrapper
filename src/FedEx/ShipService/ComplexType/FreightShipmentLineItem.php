...
'HandlingUnits' => 'nonNegativeInteger',
'Packaging' => 'PhysicalPackagingType',
'Pieces' => 'nonNegativeInteger',
'NmfcCode' => 'string',
'HazardousMaterials' => 'HazardousCommodityOptionType',
...
'Volume' => 'Volume',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\HazardousCommodityOptionType|string
     */
    ...
    {
        $this->__set('ClassProvidedByCustomer', $classProvidedByCustomer);
    ...
    {
        $this->__set('HandlingUnits', $handlingUnits);
    ...
    {
        $this->__set('HazardousMaterials', $hazardousMaterials);
