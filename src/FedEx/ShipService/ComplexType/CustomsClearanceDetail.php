...
'DeclarationStatementDetail' => 'CustomsDeclarationStatementDetail',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\ClearanceBrokerageType|string
     */
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\InternationalDocumentContentType|string
     */
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\FreightOnValueType|string
     */
    ...
    /**
     * @var CustomsDeclarationStatementDetail
     */
    ...
    {
        $this->__set('DeclarationStatementDetail', $declarationStatementDetail);
