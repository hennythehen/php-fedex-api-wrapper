...
'PrintedReferences' => 'PrintedReference',
...
'HazardousMaterialsEmergencyContactNumber' => 'string',
...
'LineItems' => 'FreightShipmentLineItem',
    ...
    /**
     * @var PrintedReference[]
     */
    public $PrintedReferences = array();

        
    /**
     * @var \FedEx\ShipService\SimpleType\FreightShipmentRoleType|string
     */
    public $Role;

        
    /**
     * @var \FedEx\ShipService\SimpleType\FreightCollectTermsType|string
     */
    ...
    {
        $this->__set('PrintedReferences', $printedReferences);
    ...
    {
        $this->__set('HazardousMaterialsEmergencyContactNumber', $hazardousMaterialsEmergencyContactNumber);
