...
'ErrorLabels' => 'ShippingDocument',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\NotificationSeverityType|string
     */
    ...
    {
        $this->__set('CompletedShipmentDetail', $completedShipmentDetail);
    ...
    {
        $this->__set('ErrorLabels', $errorLabels);
