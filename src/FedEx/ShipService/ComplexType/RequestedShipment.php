...
'ManifestDetail' => 'ShipmentManifestDetail',
'TotalWeight' => 'Weight',
...
'RequestedPackageLineItems' => 'RequestedPackageLineItem',
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\DropoffType|string
     */
    public $DropoffType;

        
    /**
     * @var \FedEx\ShipService\SimpleType\ServiceType|string
     */
    public $ServiceType;

        
    /**
     * @var \FedEx\ShipService\SimpleType\PackagingType|string
     */
    public $PackagingType;

        
    /**
     * @var ShipmentManifestDetail
     */
    ...
    /**
     * @var \FedEx\ShipService\SimpleType\EdtRequestType|string
     */
    ...
    {
        $this->__set('ManifestDetail', $manifestDetail);
